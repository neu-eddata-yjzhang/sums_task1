...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
    ...
    zyj = os.path.join(save_dir,'labels/')
    os.mkdir(zyj)
    # Half
                ...
                for *poly, conf, cls in reversed(det):
                    if save_txt:  # Write to file
                        ...
                        with open(txt_path + '.txt', 'a') as f:
                            ...
                            f.write(str(int(poly[0]))+' '+str(int(poly[1]))+' '+str(int(poly[2]))+' '+str(int(poly[3]))+' '+str(int(poly[4]))+' '+str(int(poly[5]))+' '+str(int(poly[6]))+' '+str(int(poly[6]))+' '+zyj_label+'\n')
                        # exit()
